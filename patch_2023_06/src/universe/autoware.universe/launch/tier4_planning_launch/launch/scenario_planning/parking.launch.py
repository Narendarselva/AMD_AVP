        ...
        composable_node_descriptions=[
            ComposableNode(
                ...
                remappings=[
                    ...
                    ("~/input/polygon", "/perception/motovis/freespace/debug/polygon"),
                    ("~/input/marker_array", "/sensing/valeo/ultrasonics/freespace_marker_lines"),
                ],
                parameters=[
                    {
                        "costmap_frame": "map",
                        ...
                        "is_pointcloud_simulated": True,
                        "use_wayarea": False,
                        "use_parkinglot": False,
                        "use_objects": False,
                        "use_points": True,
                        "use_freespace_polygon": True,
                        "use_freespace_marker": True,
...
def generate_launch_description():
    ...
    # NAREN - enabled multithread for freespace planner node to optimize 
