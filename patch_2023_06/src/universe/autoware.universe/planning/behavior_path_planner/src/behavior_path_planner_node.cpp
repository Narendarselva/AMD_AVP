...
PullOutParameters BehaviorPathPlannerNode::getPullOutParam()
{
  ...
  // single arc pull out
  p.enable_single_arc_pull_out = declare_parameter<bool>(ns + "enable_single_arc_pull_out");
  p.single_arc_pull_out_velocity = declare_parameter<double>(ns + "single_arc_pull_out_velocity");
  p.single_arc_path_interval = declare_parameter<double>(ns + "single_arc_path_interval");
  p.single_arc_lane_departure_margin = declare_parameter<double>(ns + "single_arc_lane_departure_margin");
  p.single_arc_max_steer_angle = declare_parameter<double>(ns + "single_arc_max_steer_angle");
