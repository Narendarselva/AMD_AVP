...
struct PullOutParameters
{
  ...
  // single arc pull out
  bool enable_single_arc_pull_out;
  double single_arc_pull_out_velocity;
  double single_arc_path_interval;
  double single_arc_lane_departure_margin;
  double single_arc_max_steer_angle;
};
