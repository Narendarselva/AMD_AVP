...
public:
  ...
  lanelet::ConstPolygons3d getParkingLots() const;
  std::shared_ptr<lanelet::ConstPolygon3d> getParkingLot(const geometry_msgs::msg::Pose & current_pose) const;
  lanelet::ConstLanelets getLinkedLanelets(const lanelet::ConstPolygon3d & parking_lot);
  bool getClosestLaneletFromPose(const geometry_msgs::msg::Pose & current_pose,
...
private:
  ...
  lanelet::ConstPolygons3d all_parking_lots_;
