...
public:
  ...
  virtual void resetObstacleTable();
  ...
  virtual size_t getObstacleIndexOnTrajectory(const geometry_msgs::msg::PoseArray & trajectory) const;
...
protected:
  ...
  // dummy is_obstacle's table with no obstacle
  std::vector<std::vector<bool>> dummy_obstacle_table_;
