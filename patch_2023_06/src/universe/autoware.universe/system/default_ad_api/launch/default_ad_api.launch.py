...
#NAREN - commented modules not needed
def generate_launch_description():
    ...
    container = ComposableNodeContainer(
		...
		# NAREN - NOTE this for setting the log level for container
        ros_arguments=["--log-level", "default_ad_api.container:=WARN"],
        composable_node_descriptions=components,
    )
    # NAREN - Skipping node launch
    ...
    #return launch.LaunchDescription([argument, container, web_server]) # NAREN
    return launch.LaunchDescription([argument, container]) # NAREN
