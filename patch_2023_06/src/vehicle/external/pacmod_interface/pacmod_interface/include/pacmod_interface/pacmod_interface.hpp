...
private:
  typedef message_filters::sync_policies::ApproximateTime<
    ...
    // NAREN -- turn msg not needed published at low rate so removed
  ...
  void onTurnRpt(const pacmod3_msgs::msg::SystemRptInt::ConstSharedPtr msg);
  ...
  bool need_separate_engage_sequence_;  // when you use a newer version of firmware than 3.3, it
                                        // must be true
  bool use_steering_tire_angle_directly_;// Used for HIL setup
